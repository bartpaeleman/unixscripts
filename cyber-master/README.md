...
**Interactive Mode:**
- `interactive`: Start the interactive wizard to guide you through analyzing an Email or doing Recon on a Domain/IP. Allows selecting output formats (Terminal UI, JSON, HTML/MD).
